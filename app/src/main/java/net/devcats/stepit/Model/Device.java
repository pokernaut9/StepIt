...
public abstract class Device {
    ...
    public static final int TYPE_ANDROID_WEARABLE = 0;
    ...
    public abstract void connect(FragmentActivity activity);
    public abstract void remove(FragmentActivity activity);
